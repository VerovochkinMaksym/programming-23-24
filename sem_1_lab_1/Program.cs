class Program
{
    ...
    class Player : IDisposable
    {
        ...
        private static void Start(bool coach)
        {
            Console.Clear();
            team = team.FindAll(x => x.GetSpeciality() == "coach" && coach == false);
            if (coach)
                Coach.CreateCoach();
            team_name = null;
            do
        ...
        protected static int Count(string position)
        {
            return team.Count(x => x._position == position);
        }
        protected virtual string GetSpeciality()
        {
            return "player";
        }
        protected virtual int PowerComputing(string position)
        {
            Random R = new Random();
    ...
    class Coach : Player
    {
        ...
        protected override string GetSpeciality()
        {
            return "coach";
        }
    ...
    static void Main()
    {
        Console.WriteLine("player - add a new non-professional player to the team\n" +
                          "goalkeeper - add a new professional goalkeeper to the team\n" +
                          "defender - add a new professional defender to the team\n" +
                          "midfielder - add a new professional midfielder to the team\n" +
                          "attacker - add a new professional attacker to the team\n" +
        ...
        while (true)
        {
            ...
            {
                case "player": 
                    try { Player.CreatePlayer(); }
                    catch (NullReferenceException) { Console.WriteLine("You are out of the limit"); }
                    break;
                case "goalkeeper":
                    try { Goalkeeper.CreateGoalkeeper(); }
                    catch (NullReferenceException) { Console.WriteLine("You are out of the limit"); }
                    break;
                case "defender":
                    try { Defender.CreateDefender(); }
                    catch (NullReferenceException) { Console.WriteLine("You are out of the limit"); }
                    break;
                case "midfielder":
                    try { Midfielder.CreateMidfielder(); }
                    catch (NullReferenceException) { Console.WriteLine("You are out of the limit"); }
                    break;
                case "attacker":
                    try { Attacker.CreateAttacker(); }
                    catch (NullReferenceException) { Console.WriteLine("You are out of the limit"); }
                    break;
